// returns the blogs with the highest number of reports descending
...
export default async function handler(req, res) {
	if (req.method === "GET") {
		...
		try {
			...
			const reportedBlogs = await prisma.Post.findMany({
				where: {
					reportCount: {
						gt: 0,
					},
			...
			// THE totalCount and return statement below were generated using GITHUB COPILOT
